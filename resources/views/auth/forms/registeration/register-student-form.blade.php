<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('register.student') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('parent_email') ? ' has-error' : '' }}">
                <label for="parent_email" class="col-md-4 control-label">Parent's Email</label>
